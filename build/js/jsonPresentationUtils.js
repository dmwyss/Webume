function funk9(aoIn, sSortFields, isAscending) {
...
function funk0(ao, oParent, sParentFieldName, sIdentifierFieldName, iDepth) {
...
funk0(ao, oNextLevelDownObjectTemp, sParentFieldName, sIdentifierFieldName, iDepth + 1);
}
}
