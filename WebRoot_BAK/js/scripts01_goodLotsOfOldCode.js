$(document).ready(function(){
	...
	*/
	gotoFachEins();
	setUpFachHeadings();
	writeTimelineWrapper();
});

function writeTimelineWrapper(){
	var sOut = "";
...
function decorateFachBackground(sAreaId, sText, asHints){
	...
	sOut += "<div class=\"topBanner-topicText\" style=\"top:-17px;right:153px;\">" + sText + "</div>";
	sOut += "<div class=\"topBanner-topicText\" style=\"top:-17px;right:147px;\">" + sText + "</div>";
...
/*
var g_iFontSizeOnStart = 10;
 * Increase or decrease the size of the body font.
function changeFontSize(iSize) {
	var areaBody = document.getElementsByTagName('body')[0];
	if(typeof iSize == "undefined"){
		iSize = g_iFontSizeOnStart;
	}
    areaBody.style.fontSize = iSize + 'pt';
}
 */
